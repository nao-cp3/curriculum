...
public class DBSelect {
    ...
    private static final String PASS = "uednoy19";
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            "jdbc:postgresql://localhost:5432/lesson_db", "postgres", "uednoy19");
            statement = connection.createStatement();
            // 問⑤ SHOHIN_IDが001と020のものを表示させるためのSQL文を記述しましょう。
            String SQL = "SELECT shohin_id, shohin_name, tanka FROM tb_shohin WHERE shohin_id IN('001', '020')";
